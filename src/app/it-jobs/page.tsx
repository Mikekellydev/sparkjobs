    ...
    <main className="space-y-8 text-slate-100">
      ...
      {hasJobs ? (
        ...
        <div className="card p-6 text-slate-200">
          <p className="font-display text-xl text-white">No senior IT jobs cached yet.</p>
          <p className="mt-2 text-sm text-slate-300">
            Pull real jobs with `npm run ingest:fetch`, commit the updated `data/latest-feeds.json`,
            and redeploy. Only mid/executive IT titles are shown here.
          </p>
        </div>
      )}
